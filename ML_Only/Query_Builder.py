...
class QueryBuilder:
    ...
    def build_query_by_word_id(self, word_id: str) -> str:
        """
        Builds a SPARQL query to look for word by a given id.
        :param word_id: (string) id of the sentence to look for.
        :return: A SPARQL query String.
        """
    ...
    def build_query_by_word_id_depgraph(self, word_id: str) -> str:
        """
        Builds a SPARQL query to look for word by a given id.
        :param word_id: (string) id of the sentence to look for.
        :return: A SPARQL query String.
        ...
        SELECT ?p ?o
        WHERE {
            <""" + word_id + """> <"""+ self.main_uri+"""depGraph>* ?o . 
        }
        """

        return query

    def build_query_attributes(self, type):
        if type == "Feats":
            query = """
                PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
                ...
                PREFIX dbp:  <http://dbpedia.org/resource/>
                PREFIX hlt: <""" + self.main_uri +""">
                
                SELECT ?r ?p ?o
                WHERE {
                    ?s rdfs:subClassOf hlt:Feats .
                    ?r rdf:type ?s .
                    ?r ?p ?o .
                }           
            """
    ...
    @dispatch(str, str)
    def build_query_by_sentence_id(self, doc_id: str, sentence_id: str) -> str:
        """
        Builds a SPARQL query to look for sentences by a given id.
        :param str_id: (int) id of the sentence to look for.
        :return: A SPARQL query String.
        ...
        SELECT ?s ?p ?o
        WHERE {
            <""" + self.main_uri + """Sentence_""" + doc_id + """_""" + sentence_id + """> <""" + self.main_uri + """depGraph>* ?s . 
            ?s ?p ?o .
        }
        """
        return query
