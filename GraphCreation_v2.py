...
graph = CreateGraph(folder=config_data['folder'], graph_name=config_data['graph_name'], extra_connetions=config_data['extra_connections']['connections'],
                    ...
                    preprocessing=preprocess_sentence_datasets, in_memory=config_data['in_memory'])

#graph.create_graph(save_file=config_data['save_file'], coref=True)
graph.create_graph_from_datasets(dataset_name = "conll2003", save_file=config_data['save_file'], coref=True)
